...
const unidadesParanagua = ["Escola M. Eva Cavani", "Escola M. Almirante Tamandaré", "CMEI Anita de Castro", "CMEI Cleide Maria Portela"];
const unidadesMatinhos = ["Escola M. Wallace Thadeu de Mello e Silva", "Escola M. Francisco dos Santos Junior", "Escola M. Eloína Rosa de Souza", "CMEI Pequeno Príncipe", "CMEI Beija-Flor"];
...
function verificarEstado() {
    ...
    const cidInput = document.getElementById('input-cidade');
...
function verificarCidade() {
    ...
    const escSel = document.getElementById('select-escola');
    ...
    } else if(cidadesPR.includes(cidade)) {
        escSel.disabled = false;
...
function salvarNovoCard() {
    ...
    if(icon && text && speak) {
        ...
        renderizarCards(); fecharModal();
        document.getElementById('custom-url').value = "";
    } else { alert("Preencha o nome, fala e escolha um ícone ou cole a URL!"); }
}
